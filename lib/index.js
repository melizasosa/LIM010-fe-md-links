...
exports.functionValidateLinks = exports.functionExtractedLinkFile = exports.functionReadAllFiles = exports.functionReadFileS = exports.functionIsFileMd = exports.functionFilePathExists = exports.functionTypePath = void 0;
...
const functionExtractedLinkFile = theRoute => {
  const arrLinks = [];
...
exports.functionExtractedLinkFile = functionExtractedLinkFile;

const functionValidateLinks = theRouter => {
  ...
  console.log(Promise.all(urlFileMd));
  return Promise.all(urlFileMd);
};

exports.functionValidateLinks = functionValidateLinks;

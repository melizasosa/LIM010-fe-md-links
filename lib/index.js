...
const functionValidate = arrayLinks => {
  let arrayValidate = [];
  const totalElementosArray = arrayLinks.map(elemento => elemento.href); // const sinRepetidos = totalElementosArray.filter((valor, indiceActual, arreglo) => arreglo.indexOf(valor) === indiceActual);
